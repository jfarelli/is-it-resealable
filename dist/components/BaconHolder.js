...
const BaconHolder = ({ data, displayBaconDetails, }) => {
    const [searchInput, setSearchInput, checkboxInput, setCheckboxInput, 
    // eslint-disable-next-line no-unused-vars
    selectedCompany, filteredSearchData, companyButtons,] = (0, useSearchAndFilter_1.default)(data);
    return (react_1.default.createElement("div", { className: "flex mt-16 mb-4 bg-[#fdf2e3]" },
        react_1.default.createElement(SidebarNav_1.default, { searchInput: searchInput.toString(), checkboxInput: checkboxInput === 'true', setCheckboxInput: setCheckboxInput, setSearchInput: setSearchInput, companyButtons: companyButtons }),
