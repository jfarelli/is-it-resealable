...
describe('SocialMediaButtons', () => {
    ...
    test('renders social media buttons with correct links', () => {
        ...
        const websiteButton = react_2.screen.getByRole('link', { name: /website/i });
        const facebookButton = react_2.screen.getByRole('link', { name: /facebook/i });
        const twitterButton = react_2.screen.getByRole('link', { name: /twitter/i });
        expect(websiteButton).toHaveAttribute('href', selectedBacon.companyContacts.website);
        expect(facebookButton).toHaveAttribute('href', selectedBacon.companyContacts.facebook);
        expect(twitterButton).toHaveAttribute('href', selectedBacon.companyContacts.twitter);
    });
