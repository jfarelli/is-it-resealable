...
describe('Landing', () => {
    test('renders the Landing component', () => {
        ...
        expect(react_2.screen.getByText(/is it resealable/i)).toBeInTheDocument();
    ...
    test('applies the correct styles to the elements', () => {
        ...
        expect(react_2.screen.getByText(/is it resealable/i)).toHaveStyle('font-size: 2em');
    ...
    test('should fail to apply incorrect styles to the elements', () => {
        ...
        expect(react_2.screen.getByText(/is it resealable/i)).not.toHaveStyle('font-size: 1em');
